...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LifePulse — Sticky notes, notebooks, and calendar in one cozy home" },
      {
        name: "description",
        content:
          "LifePulse is a warm personal organizer for sticky notes, nested notebooks, tasks and a calendar — all on one dashboard.",
      },
      { name: "author", content: "LifePulse" },
      { property: "og:title", content: "LifePulse — Your cozy personal life organizer" },
      {
        property: "og:description",
        content:
          "Sticky notes, notebooks, tasks and calendar unified in a soft, warm dashboard.",
      },
