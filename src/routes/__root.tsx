...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LifeOS — Sticky notes, notebooks, and calendar in one cozy home" },
      {
        name: "description",
        content:
          "LifeOS is a warm personal organizer for sticky notes, nested notebooks, tasks and a calendar — all on one dashboard.",
      },
      { name: "author", content: "LifeOS" },
      { property: "og:title", content: "LifeOS — Your cozy personal life organizer" },
      {
